...
// The full extracted stock range — including items that don't map to a
// single category (galvanised pipe, bolt & nuts, submersible pump) — shown
// as its own gallery so nothing from the source catalog is left out.
